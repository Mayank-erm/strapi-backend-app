...
export interface ApiProposalProposal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chooseEmployee: Schema.Attribute.Relation<
      'manyToOne',
      'api::employee.employee'
    >;
    ...
    > &
      Schema.Attribute.Private;
    opportunityNumber: Schema.Attribute.String;
    proposalName: Schema.Attribute.String;
    proposedBy: Schema.Attribute.String;
    pstatus: Schema.Attribute.Enumeration<
